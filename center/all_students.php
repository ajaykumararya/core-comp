                ...
                <?php
                    while($g = $get->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td><a href="?id='.$g['id'].'&action=del&file='.$g['photo'].'" class="btn btn-danger" onclick="return confirm(\'Are you sure you want to delete student\')"><i class="fa fa-trash"></i></a></td>
                        </tr>';
                    }
                ?>
            </tbody>
