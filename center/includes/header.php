...
">
        <li class="active"><a data-toggle="modal" data-target="#payment-modal" href="javascript:;" style="
            font-weight: 900;
            font-size: 21px;
        ">Wallet Balance : <?=WALLET_BALANCE?> <i class="fa fa-rupee"></i> <span class="sr-only">(current)</span></a>
        
        
        </li>
        <li class="hidden-xs">
            <a href="javascript:;" class="btn btn-info btn-sm" data-toggle="modal" data-target="#payment-modal" style="    line-height: 0;    margin-top: 10px;    margin-left: 5px;">Load Wallet</a>
        </li>
                </ul>
...
<!-- <li><a href="manage_download.php"><i class="fa fa-download"></i> <span>Manage Download</span></a></li> -->
    ...
    <section class="content-header">
      ...
      <section class="content">
            <form action="razorepay/process.php" id="checkout-selection" method="POST">
                    
                    
               
          <div class="modal fade" id="payment-modal" style="display: none;">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Load Wallet</h4>
            </div>
