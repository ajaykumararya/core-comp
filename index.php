        ...
        <section class="hero hero-home">
            <div class="swiper-container hero-slider swiper-container-horizontal">
                ...
                <div class="swiper-pagination swiper-pagination-clickable swiper-pagination-bullets">
                    ...
                    for ($i = 0; $i < $sliderResult->num_rows; $i++) {
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<div class="serviceBox">						
						...
						<p class="description text-justify">
						    An Autonomous Organization Managed & Run by SHIVAJI MAHARAJ YOUTH COMPUTER ACADEMY Registered With Govt.Of India NGO Registration Act & ISO Certified Organization
							<!--An Autonomous Organization Managed & Run by <?=PROJECT_NAME?>. Registered with Govt. of Himachal Pradesh Under Societies Registration Act Vide Regd. No. 508/011 Dated 14 Oct. 2011						</p>-->
