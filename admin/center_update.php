		...
		<div class="box-body">
			<form action="" method="post" enctype="multipart/form-data">
				...
				<div class="form-group col-lg-4 col-xs-12 col-sm-12">
				    ...
				    <input type="date" name="valid_upto" class="form-control" required value="<?=$get['valid_upto']?>">
				</div>
				<!--<div class="form-group col-lg-4 col-xs-12 col-sm-12">-->
				<!--	<label>Marksheet Price</label>-->
				<!--	<input type="number" min="0" name="marksheet" class="form-control" value="<?=paymentConfig('marksheet',$get['id'])?>">-->
				<!--</div>-->
				<!--<div class="form-group col-lg-4 col-xs-12 col-sm-12">-->
				<!--	<label>Certificate Price</label>-->
				<!--	<input type="number" min="0" name="certificate" class="form-control" value="<?=paymentConfig('certificate',$get['id'])?>">-->
				<!--</div>-->
				<div class="form-group col-lg-12 col-xs-12 col-sm-12">
