...
if ($_POST['submit'] == 'update') {
    ...
    $query = '';
    if ($file) {
        $query = ", `image` = '".$file['file_name']."'";
    }
    
    if($con->query("UPDATE `intro` SET `heading` = '".$_POST['heading']."', `description` = '".$_POST['description']."',`btn_link` = '".$_POST['btn_link']."' $query WHERE `id` = 1")){
...
$selectIntro = $con->query("SELECT * FROM intro WHERE id = 1")->fetch_assoc();
?>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <label>Heading</label>
                                <input type="text" name="heading" value="<?=$selectIntro['heading']?>" class="form-control" placeholder="Enter Welcome Heading">
                            </div>
                             <div class="form-group">
                        
                                <label>Image</label>
                                <input type="file" name="image" class="form-control" placeholder="Enter Welcome Heading">
                                <img class="img-rounded form-control" style="height:200px" src="<?=BASE_URL?>uploads/intro/<?=$selectIntro['image']?>">
                            </div>
                            
                            <div class="form-group">
                                <label>Description</label>
                                <textarea name="description" class="form-control"><?=$selectIntro['description']?></textarea>
                                <!--<textarea type="message" name="description" class="form-control" placeholder=" Enter Description"></-->
                            </div>
                             <div class="form-group">
                                <label>link</label>
                                <input type="text" name="btn_link"value="<?=$selectIntro['btn_link']?>" class="form-control" placeholder=" Enter Link">
                            </div>
                        </div>
                        <div class="box-footer">
